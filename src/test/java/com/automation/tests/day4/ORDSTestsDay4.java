...
public class ORDSTestsDay4 {
    ...
    @Test()
    @DisplayName("Verify Status Code,Content Type,Repond Time")
    ...
    public void verifyCountriesTest1() {
        ...
        //collectionName.findAll{it.propertyName=='Value'}--to get collections objects where properties equal to some value
     ...
     //let's find employee with higest salary .Use GPath
    ...
    @Test
    public void verifyPhoneNumaber(){
